                                ...
                                <div className="col-md-6">
                                    <div className="post-entry-1">
                                        <a href="post-single.html">
                                            <img
                                                src="https://preview.colorlib.com/theme/meranda/images/img_h_1.jpg"
                                                alt="Image"
                                                className="img-fluid"
                                            />
                                        </a>
                                ...
                                <div className="col-md-6">
                                    <div className="post-entry-2 d-flex">
                                        <div
                                            ...
                                            style={{
                                                backgroundImage:
                                                    "url(https://preview.colorlib.com/theme/meranda/images/img_h_1.jpg)",
                                            }}
                                        />
                                    ...
                                    <div className="post-entry-2 d-flex">
                                        <div
                                            ...
                                            style={{
                                                backgroundImage:
                                                    'url("./assets/images/big/img4.jpg")',
                                            }}
                                        />
                                        <div className="contents">
                                            <h2>
